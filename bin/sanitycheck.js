...
apps.forEach((app,appIdx) => {
  ...
  if (app.type == "widget" && !app.id.startsWith("wid")) ERROR(`Widget app ${app.id} id does not start with 'wid'`, {file:metadataFile});
  if (app.type == "clkinfo" && !app.id.startsWith("clkinfo")) ERROR(`ClockInfo app ${app.id} id does not start with 'clkinfo'`, {file:metadataFile});
